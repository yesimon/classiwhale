...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('confidence_bayes_pUAFgR', (
            ('id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['twitterauth.UserProfile'])),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['twitterauth.UserProfile'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('confidence_bayes_pUAFgR')
