...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MultinomialBayesModel'
        db.create_table('multinomialbayes_multinomialbayesmodel', (
            ...
            ('user_profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['twitter.TwitterUserProfile'])),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('multinomialbayes', ['MultinomialBayesModel'])

        # Adding model 'TokenDictionary'
        db.create_table('multinomialbayes_tokendictionary', (
            ('id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('token', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('multinomialbayes', ['TokenDictionary'])

    def backwards(self, orm):
        # Deleting model 'MultinomialBayesModel'
        db.delete_table('multinomialbayes_multinomialbayesmodel')

        # Deleting model 'TokenDictionary'
        db.delete_table('multinomialbayes_tokendictionary')
    ...
    models = {
        ...
        'multinomialbayes.multinomialbayesmodel': {
            'Meta': {'object_name': 'MultinomialBayesModel'},
            'data': ('picklefield.fields.PickledObjectField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user_profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['twitter.TwitterUserProfile']"}),
            'version': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        'multinomialbayes.tokendictionary': {
            'Meta': {'object_name': 'TokenDictionary'},
    ...
    complete_apps = ['multinomialbayes']