...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PredictionStatistics.auc'
        db.add_column('corsair_predictionstatistics', 'auc', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PredictionStatistics.auc'
        db.delete_column('corsair_predictionstatistics', 'auc')
