...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Status.author'
        db.rename_column('status_status', 'author_id', 'user_profile_id')


        # Changing field 'Status.created_at'
        db.alter_column('status_status', 'created_at', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):

        db.rename_column('status_status', 'user_profile_id', 'author_id')

        # Changing field 'Status.created_at'
        db.alter_column('status_status', 'created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2010, 12, 19)))
    ...
    models = {
        ...
        'status.status': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['twitterauth.UserProfile']", 'null': 'True', 'blank': 'True'})
        },
        'twitterauth.rating': {
