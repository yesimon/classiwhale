...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Classifier.object'
        db.delete_column('classifier_classifier', 'object')

        # Adding field 'Classifier.classifier'
        db.add_column('classifier_classifier', 'classifier', self.gf('picklefield.fields.PickledObjectField')(default=1), keep_default=False)

        # Adding field 'Classifier.name'
        db.add_column('classifier_classifier', 'name', self.gf('django.db.models.fields.CharField')(default=1, max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Classifier.object'
        db.add_column('classifier_classifier', 'object', self.gf('picklefield.fields.PickledObjectField')(default=1), keep_default=False)

        # Deleting field 'Classifier.classifier'
        db.delete_column('classifier_classifier', 'classifier')

        # Deleting field 'Classifier.name'
        db.delete_column('classifier_classifier', 'name')
