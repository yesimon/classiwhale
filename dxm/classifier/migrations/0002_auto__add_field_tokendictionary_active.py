...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TokenDictionary.active'
        db.add_column('classifier_tokendictionary', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TokenDictionary.active'
        db.delete_column('classifier_tokendictionary', 'active')
