...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('classifier_classifier', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('object', self.gf('picklefield.fields.PickledObjectField')()),
            ('user_profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['twitterauth.UserProfile'])),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('classifier', ['Classifier'])

        # Adding model 'TokenDictionary'
        db.create_table('classifier_tokendictionary', (
            ('id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('token', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal('classifier', ['TokenDictionary'])


    def backwards(self, orm):
        
        # Deleting model 'Classifier'
        db.delete_table('classifier_classifier')

        # Deleting model 'TokenDictionary'
        db.delete_table('classifier_tokendictionary')
    ...
    models = {
        ...
        'classifier.classifier': {
            ...
            'object': ('picklefield.fields.PickledObjectField', [], {}),
