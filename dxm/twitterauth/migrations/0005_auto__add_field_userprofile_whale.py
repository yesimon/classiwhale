...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.whale'
        db.add_column('twitterauth_userprofile', 'whale', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['whale.Whale'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.whale'
        db.delete_column('twitterauth_userprofile', 'whale_id')
    ...
    models = {
        ...
        'twitterauth.userprofile': {
            ...
            'whale': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['whale.Whale']", 'null': 'True', 'blank': 'True'})
        },
        'whale.whale': {
