...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.active_classifier'
        db.add_column('twitterauth_userprofile', 'active_classifier', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='active_classifier', null=True, to=orm['classifier.Classifier']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.active_classifier'
        db.delete_column('twitterauth_userprofile', 'active_classifier_id')
