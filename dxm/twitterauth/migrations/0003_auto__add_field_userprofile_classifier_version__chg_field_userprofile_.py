...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.classifier_version'
        db.add_column('twitterauth_userprofile', 'classifier_version', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)

        # Renaming column for 'UserProfile.active_classifier' to match new field type.
        db.rename_column('twitterauth_userprofile', 'active_classifier_id', 'active_classifier')
        # Changing field 'UserProfile.active_classifier'
        db.alter_column('twitterauth_userprofile', 'active_classifier', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Removing index on 'UserProfile', fields ['active_classifier']
        db.delete_index('twitterauth_userprofile', ['active_classifier_id'])


    def backwards(self, orm):
        
        # Adding index on 'UserProfile', fields ['active_classifier']
        db.create_index('twitterauth_userprofile', ['active_classifier_id'])

        # Deleting field 'UserProfile.classifier_version'
        db.delete_column('twitterauth_userprofile', 'classifier_version')

        # Renaming column for 'UserProfile.active_classifier' to match new field type.
        db.rename_column('twitterauth_userprofile', 'active_classifier', 'active_classifier_id')
        # Changing field 'UserProfile.active_classifier'
        db.alter_column('twitterauth_userprofile', 'active_classifier_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['classifier.Classifier']))
