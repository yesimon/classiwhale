...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WhaleSpecies.evolution'
        db.add_column('whale_whalespecies', 'evolution', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['whale.WhaleSpecies'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WhaleSpecies.evolution'
        db.delete_column('whale_whalespecies', 'evolution_id')
