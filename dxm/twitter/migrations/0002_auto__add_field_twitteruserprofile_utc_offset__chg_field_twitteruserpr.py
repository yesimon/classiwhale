...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TwitterUserProfile.utc_offset'
        db.add_column('twitter_twitteruserprofile', 'utc_offset', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Changing field 'TwitterUserProfile.user'
        db.alter_column('twitter_twitteruserprofile', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profile.UserProfile'], null=True))


    def backwards(self, orm):
        
        # Deleting field 'TwitterUserProfile.utc_offset'
        db.delete_column('twitter_twitteruserprofile', 'utc_offset')

        # Changing field 'TwitterUserProfile.user'
        db.alter_column('twitter_twitteruserprofile', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['profile.UserProfile']))
