...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Status.place'
        db.alter_column('twitter_status', 'place', self.gf('picklefield.fields.PickledObjectField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Status.place'
        db.alter_column('twitter_status', 'place', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    models = {
        ...
        'twitter.status': {
            ...
            'place': ('picklefield.fields.PickledObjectField', [], {'null': 'True', 'blank': 'True'}),
