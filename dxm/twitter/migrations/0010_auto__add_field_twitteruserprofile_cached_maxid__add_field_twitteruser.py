...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TwitterUserProfile.cached_maxid'
        db.add_column('twitter_twitteruserprofile', 'cached_maxid', self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'TwitterUserProfile.cached_minid'
        db.add_column('twitter_twitteruserprofile', 'cached_minid', self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Status.place'
        db.delete_column('twitter_status', 'place')


    def backwards(self, orm):
        
        # Deleting field 'TwitterUserProfile.cached_maxid'
        db.delete_column('twitter_twitteruserprofile', 'cached_maxid')

        # Deleting field 'TwitterUserProfile.cached_minid'
        db.delete_column('twitter_twitteruserprofile', 'cached_minid')

        # Adding field 'Status.place'
        db.add_column('twitter_status', 'place', self.gf('picklefield.fields.PickledObjectField')(null=True, blank=True), keep_default=False)
