...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TwitterUserProfile.last_updated'
        db.add_column('twitter_twitteruserprofile', 'last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2011, 2, 11), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TwitterUserProfile.last_updated'
        db.delete_column('twitter_twitteruserprofile', 'last_updated')
