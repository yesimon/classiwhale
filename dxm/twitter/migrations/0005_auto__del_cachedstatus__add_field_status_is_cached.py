...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Status.is_cached'
        db.add_column('twitter_status', 'is_cached', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Status.is_cached'
        db.delete_column('twitter_status', 'is_cached')
