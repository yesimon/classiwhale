...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CylonBayesModel'
        db.create_table('cylonbayes_cylonbayesmodel', (
        ...
        db.send_create_signal('cylonbayes', ['CylonBayesModel'])

    def backwards(self, orm):
        # Deleting model 'CylonBayesModel'
        db.delete_table('cylonbayes_cylonbayesmodel')
