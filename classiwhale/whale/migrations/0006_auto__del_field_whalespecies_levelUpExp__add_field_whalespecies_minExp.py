...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WhaleSpecies.minExp'
        db.add_column('whale_whalespecies', 'minExp', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'WhaleSpecies.minExp'
        db.delete_column('whale_whalespecies', 'minExp')
